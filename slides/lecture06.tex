...
% \usepackage{psfig}
\usepackage{booktabs, graphicx, lineno, multicol, hyperref, cleveref,color}
...
\lecture{Lecture 6. Supervised PCA, Dual PCA (MDS), and RKHS}{Yuan Yao}{Zhao Yuqi}{Mar. 13, 2017}
...
\end{enumerate}
\item Robust PCA: Looking for the decomposition $X = L + S$, 
      where \begin{itemize}
...
For given data $(X_i,y_i)$, where $X_i \in \mathbb{R}^p$, and $y_i$ is discrete in ${\{1,2,...,K\}}$ not ordered.
